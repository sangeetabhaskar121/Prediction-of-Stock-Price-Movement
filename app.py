...
if st.checkbox("Show Credits"):
    ...
    st.sidebar.info(
        """
        1. [Yasin Sir](https://www.linkedin.com/in/yasinshah9598/)\n
        2. [Deepika](https://www.linkedin.com/in/deepikagoel1/)\n
        3. Team @ [Technocolab](https://www.linkedin.com/company/technocolabs/)\n
        """)
    st.sidebar.subheader("Contributors/Project Team")
    st.sidebar.info(
        "1. [Rahul Chawla](https://www.linkedin.com/in/rahul-chawla-942b47150/)\n"
        "2. [Abhishek Sharma](https://www.linkedin.com/in/abhishek-sharma-285a48205/)\n"
...
**Credits**
- App built by [Welcome to Technocolabs Team B](https://medium.com/@chanin.nantasenamat) (aka [Data Professor](http://youtube.com/dataprofessor))
